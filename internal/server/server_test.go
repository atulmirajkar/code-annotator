	...
	tests := []struct {
	...
	}{
		{
			...
			contains: []string{
				...
				`<code><span class="syntax-keyword">package</span> changed</code>`,
			},
...
func TestStaticAssets(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "get annotation card disclosures module", path: "/static/annotation-card-disclosures.js", method: http.MethodGet, wantStatus: http.StatusOK, wantType: "text/javascript; charset=utf-8", wantContents: []string{"bindAnnotationCardDisclosures", "annotation-reply-panel", "annotation-actions-panel"}},
		{name: "get review script", path: "/static/review.js", method: http.MethodGet, wantStatus: http.StatusOK, wantType: "text/javascript; charset=utf-8", wantContents: []string{"./annotation-card-disclosures.js", "./review-fragments.js", "./review-highlights.js", "./review-htmx.js", "./review-navigation.js", "./review-panel.js", "./review-selection.js", "./viewer-state.js", "configureReviewHTMX"}},
		...
		{name: "get diff overview module", path: "/static/diff-overview.js", method: http.MethodGet, wantStatus: http.StatusOK, wantType: "text/javascript; charset=utf-8", wantContents: []string{"./diff-overview-geometry.js", "bindDiffOverview", "scrollIntoView", "--diff-overview-track-height"}},
		{name: "get diff overview geometry module", path: "/static/diff-overview-geometry.js", method: http.MethodGet, wantStatus: http.StatusOK, wantType: "text/javascript; charset=utf-8", wantContents: []string{"layoutDiffOverviewMarkers", "layoutDiffOverviewViewport", "selectDiffOverviewLocation"}},
		{name: "get document search module", path: "/static/document-search.js", method: http.MethodGet, wantStatus: http.StatusOK, wantType: "text/javascript; charset=utf-8", wantContents: []string{"bindDocumentSearch", "fetchDocumentCatalogState", "open-comments"}},
		{name: "get viewer environment module", path: "/static/viewer-environment.js", method: http.MethodGet, wantStatus: http.StatusOK, wantType: "text/javascript; charset=utf-8", wantContents: []string{"defaultViewerEnvironment", "globalThis", "htmx"}},
		{name: "get viewer layout module", path: "/static/viewer-layout.js", method: http.MethodGet, wantStatus: http.StatusOK, wantType: "text/javascript; charset=utf-8", wantContents: []string{"bindViewerLayout", "documents-collapsed", "review-collapsed"}},
		...
		{name: "get viewer preferences module", path: "/static/viewer-preferences.js", method: http.MethodGet, wantStatus: http.StatusOK, wantType: "text/javascript; charset=utf-8", wantContents: []string{"resolveDocumentScope", "clampInteger"}},
		...
		{name: "get document tree module", path: "/static/document-tree.js", method: http.MethodGet, wantStatus: http.StatusOK, wantType: "text/javascript; charset=utf-8", wantContents: []string{"bindDocumentTree", "collapsedIds", "htmx:afterSwap", "htmx:afterSettle"}},
		{name: "get comparison state module", path: "/static/comparison-state.js", method: http.MethodGet, wantStatus: http.StatusOK, wantType: "text/javascript; charset=utf-8", wantContents: []string{"parseComparisonState", "full lowercase commit", "comparison option commits must be unique"}},
		...
		{name: "get Mermaid integration", path: "/static/mermaid.js", method: http.MethodGet, wantStatus: http.StatusOK, wantType: "text/javascript; charset=utf-8", wantContents: []string{`securityLevel: "strict"`, "maxDiagramCharacters", "initializeMermaid", "./viewer-state.js"}},
