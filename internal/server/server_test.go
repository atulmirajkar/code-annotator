...
func TestStaticAssets(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "get document tree module", path: "/static/document-tree.js", method: http.MethodGet, wantStatus: http.StatusOK, wantType: "text/javascript; charset=utf-8", wantContents: []string{"bindDocumentTree", "expandedIds", "htmx:afterSwap"}},
