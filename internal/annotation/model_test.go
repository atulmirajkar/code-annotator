...
func TestValidateTransition(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "reviewer dismisses open", from: StatusOpen, to: StatusClosed, actor: RoleReviewer, allowed: true},
		...
		{name: "agent cannot dismiss open", from: StatusOpen, to: StatusClosed, actor: RoleAgent},
