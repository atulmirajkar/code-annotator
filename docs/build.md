...
The browser includes a read-only annotation panel and previews exact selections
across source-contiguous plain text with their Markdown byte range. Highlights and
