...
and stale-anchor warnings. Selection, highlights, and browser mutation controls
are being delivered in subsequent milestone commits. By default, sidecars are stored under
