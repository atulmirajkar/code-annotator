...
recursive tree with directories before files at every level, along with paths,
counts, and filtered fragments; TypeScript uses the validated catalog only for
keyboard navigation and tab-local preferences.
